 ...
 * =======
 *
 * HPL_zaxpy scales the vector x by alpha and adds it to y.
 * 
 *
 * Arguments
 * =========
 ...
 */ 
   ...
   register const zcomplex     alpha = ALPHA;
   register zcomplex           x0, x1, x2, x3, y0, y1, y2, y3;
   const zcomplex              * StX;
   register int              i;
   int                       nu;
...
#define F77incy              INCY
#endif
   F77zaxpy( &F77N, &alpha, X, &F77incx, Y, &F77incy );
#endif
/*
 * End of HPL_zaxpy
 */
